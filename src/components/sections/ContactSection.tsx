    ...
    <section className="text-white box-border py-8 md:py-20">
      <div className="box-border w-full px-5 md:px-10">
        <div className="box-border max-w-[1312px] w-full mx-auto">
          <div className="bg-gray-800 box-border gap-x-6 flex flex-col gap-y-6 p-6 rounded-[20px] md:gap-x-20 md:flex-row md:gap-y-20 md:p-14">
            ...
            <div className="items-start box-border gap-x-6 flex basis-[0%] flex-col grow justify-between gap-y-6 text-left font-poppins md:items-end md:gap-x-[normal] md:gap-y-[normal] md:text-right">
              ...
              <Link href="/contact" className="text-gray-900 text-base font-bold bg-[var(--brand-yellow)] box-border block leading-6 text-center border border-[var(--brand-yellow)] px-5 py-2 rounded-[100px] border-solid md:text-lg md:leading-[27px] hover:bg-yellow-500 transition-colors">Contactează-ne</Link>
            </div>
          </div>
        </div>
      </div>
