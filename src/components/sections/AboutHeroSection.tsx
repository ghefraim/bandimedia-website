...
export default function AboutHeroSection() {
  return (
    <section className="relative  ">
      ...
      {/* "VIZIUNEA VOASTRĂ MISIUNEA NOASTRĂ" Banner - positioned to overlap */}
      ...
      <div className="relative px-5 py-12 md:px-10 md:py-20">
        <div className="max-w-[1312px] mx-auto text-center">
          ...
          <p className="text-white/60 text-base md:text-lg max-w-4xl mx-auto leading-relaxed font-geist font-normal tracking-wide">
