  ...
  return (
    <section className="py-16 md:py-20">
      <div className="max-w-[1312px] mx-auto px-5 md:px-10">
        ...
        {/* Story Content */}
        <div className="mb-12 md:mb-16">
          <p className="text-lg md:text-xl leading-snug max-w-4xl mx-auto text-center text-gray-700 font-medium tracking-tight">
          ...
          <p className="text-base md:text-lg leading-snug max-w-3xl mx-auto text-center text-gray-600 mt-6 font-normal tracking-tight">
